...
const socials = [
  // { Icon: FaYoutube, label: "YouTube", href: "https://youtube.com/@biranchinarayann?si=o3LJRnAIv1hgBO_-" },
  // { Icon: FaXTwitter, label: "X", href: "https://x.com/biranchi_8984" },
  { Icon: FaLinkedinIn, label: "LinkedIn", href: "https://www.linkedin.com/in/manasi-rakshit-95153a322?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" },
  { Icon: FaInstagram, label: "Instagram", href: "https://www.instagram.com/rakshit_its_me_?igsh=MW1jY3IxajdjejZqZg==" },
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/Manasi876" },
];
...
const Home = React.forwardRef((props, ref) => {
  const roles = useMemo(
    () => ["Software Developer", "Web Developer", "Content Creator" , "UI&UX Designer"],
    []
  );
