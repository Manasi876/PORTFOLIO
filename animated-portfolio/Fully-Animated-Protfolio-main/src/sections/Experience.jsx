...
const experiences = [
  {
    ...
    duration: "2021",
    description:
      "Completed secondary education with strong academic foundation and focus on core subjects.",
  },
  
  {
    role: "Science Intermediate",
    company: "Council of Higher Secondary Education",
    duration: "2021 - 2023",
    description:
      "Specialized in Science/PCM/PCMB (or your stream) with emphasis on analytical and technical skills.",
  },
{
    ...
    duration: "2023 - 2027",
    description:
      "PursuingB.Tech in Computer Science, gaining hands-on experience in software development, technology, and real-world projects.",
  },
      ...
      <div ref={sceneRef} style={{ height: `${SCENE_HEIGHT_VH}vh`, minHeight: "120vh" }} className="relative">
        <div className="sticky top-0 h-screen flex flex-col">
          ...
          <div className="shrink-0 px-6 pt-8">
            <h2 className="text-4xl sm:text-5xl font-semibold mt-5 text-center">Educational Qualification</h2>
          </div>
          {/* Timeline container */}
