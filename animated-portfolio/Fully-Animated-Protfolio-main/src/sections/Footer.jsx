...
const socials = [
  ...
  { Icon: FaLinkedinIn, label: "LinkedIn", href: "https://www.linkedin.com/in/biranchinarayanpanda898404/" },
  { Icon: FaInstagram, label: "Instagram", href: "https://www.instagram.com/_invincible_official_01?igsh=bmgzY3Rwb3ZxZWV1" },
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/Biranchi-Official-01" },
];
    ...
    <footer className="relative overflow-hidden bg-black">
      ...
      >
        ...
        <p className="text-xs text-gray-400">
          © {new Date().getFullYear()} Manasi Rakshit. All rights reserved.
        </p>
      </motion.div>
    </footer>
  );
